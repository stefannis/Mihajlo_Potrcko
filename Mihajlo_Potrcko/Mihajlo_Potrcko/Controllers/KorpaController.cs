...
namespace Mihajlo_Potrcko.Controllers
{
    public class KorpaController : Controller
    {
        ...
        public ActionResult Edit(KorpaItem item)
        {
            if (item.Value == null)
            {
                return HttpNotFound();
            ...
            MvcApplication.UpdateKorpa(Session["brojSesije"].ToString(), item.Key, item.Value.IncInt.Quantity);
        ...
        public ActionResult Delete(int index)
        {
            ...
            MvcApplication.DeleteFromKorpa(Session["brojSesije"].ToString(), index);
            return RedirectToAction("Index");
        }
        //        // GET: Korisnik/Edit/5
